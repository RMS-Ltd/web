...
**Current release notes:** [release-notes-v0.0.14.md](../releases/release-notes-v0.0.14.md)  
...
|---------|-----|--------|---------------|---------|
| **0.0.14** | `v0.0.14` | *(this release)* | [release-notes-v0.0.14.md](../releases/release-notes-v0.0.14.md) | Theme toggle fix (ES5 + CSS) |
